<div class="p-4">
    <div class="relative mb-6 w-full grid grid-cols-12 gap-4">
        <div class="col-span-12 md:col-span-6 flex justify-start items-center">
            <a href="{{ route('guru.create') }}" class="bg-gray-00 text-white px-6 py-3 rounded-md hover:bg-gray-800 transition duration-200">
                Tambah Guru
            </a>
        </div>
        <div class="col-span-12 md:col-span-6 flex justify-between items-center space-x-4">
            <div class="flex items-center space-x-2">
                <label for="search" class="text-sm font-medium text-gray-300">Search:</label>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @if ($guruList && $guruList->count())
                    ...
                    <tr class="border-b hover:bg-gray-300 transition duration-200">
                        ...
                        <td class="px-6 py-3 text-center">
                            <div x-data="{ open: false }" class="inline-block text-left">
                                ...
                                <div x-show="open" x-transition @click.away="open = false"
                                    class="absolute right-0 mt-2 w-36 bg-gray-400 border border-gray-200 rounded shadow-md z-50">
