<div class="max-w-4xl mx-auto bg-[#FFFDD0] shadow-lg rounded-lg p-6 mt-10">
    <!-- Bento -->
    ...
    <div class="text-center mt-6">
        <a href="{{ route('guru') }}"
           class="inline-block bg-gray-500 text-white px-6 py-3 rounded-md hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500 transition duration-200">
            Kembali
        </a>
    </div>
</div>
