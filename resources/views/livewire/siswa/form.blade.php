<div class="p-6 max-w-3xl mx-auto bg-gray-400 shadow-lg rounded-lg">
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            @error('nama') <span class="text-red-700 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div>
            ...
            @error('nis') <span class="text-red-700 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div>
            ...
            @error('alamat') <span class="text-red-700 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div>
            ...
            @error('kontak') <span class="text-red-700 text-sm">{{ $message }}</span> @enderror
        </div>
        ...
        <div>
            ...
            @error('status_pkl') <span class="text-red-700 text-sm">{{ $message }}</span> @enderror
        </div>
