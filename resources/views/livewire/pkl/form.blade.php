    ...
    <form wire:submit.prevent="save" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" wire:model="mulai" class="w-full mt-1  bg-yellow-700 border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="date" wire:model="selesai" class="w-full mt-1 border  bg-yellow-700 border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
